                ...
                <div class="tab-pane fade show active " id="nav-home" role="tabpanel" aria-labelledby="sieuam">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12 pt-2 pb-2"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" name="hoten" class="form-control" value="{{ 'BN' . sprintf('%05d',$dsns->bn_ma) }}" disabled>
                                    </div>
                                    <div class="col-md-1">
                                        <label for="">Họ tên</label>
                                    </div>
                                    <div class="col-md-5">
                                        <input type="text" name="hoten" class="form-control" value="{{ $dsns->bn_ten }}" style="color:red;font-weight:bold;" disabled>
                                    </div>
                                    <div class="col-md-1">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" class="form-control" name="phong" value="{{ $dsns->p_ten }}" disabled>
                                    </div>
                                    <div class="col-md-1">
                                        <label for="">Năm sinh</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control" name="gtinh" value="{{ $dsns->bn_ngaysinh }}" disabled>
                                    </div>
                                    <div class="col-md-1">
                                        <label for="">Giới tính</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control" name="gtinh" value="{{ $dsns->bn_gioitinh }}" disabled>
                                    </div>
                                    <div class="col-md-1">
                                        <label for="">Tuổi</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control" name="tuoi" value="{{ floor((time() - strtotime($dsns->bn_ngaysinh)) / 31556926); }}" disabled>
                                    </div>
                                </div>
                                <div class="row mt-1">
                                    <div class="col-md-1">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="bsichidinh"  value="{{ $dsns->cv_ten.' '.$dsns->nv_ten }}" disabled>
                                    </div>
                                    <div class="col-md-1">
                                        <label for="">Ngày chỉ định</label>
                                    </div>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="ngaychidinh" value="{{ date('d-m-Y',strtotime($dsns->ngaytaophieu)) }}" disabled>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <h3 class=" mt-2" style="font-weight:bold;color:#023e8a;">{{ $dsns->cls_ten }}</h3>
                            </div>
                        </div>
                        <form action="{{URL::to('/staff/subclinical_exam/kq_noisoi')}}" method="POST"  enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="pcd_ma" value="{{ $dsns->pcd_ma }}">
                            <input type="hidden" name="cls_ma" value="{{ $dsns->cls_ma }}">
                        <div class="row mt-3">
                            ...
                            <div class="col-md-12"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div id="preview"></div>
                                        <input type="file" name="anhnoisoi[]" id="anhnoisoi" multiple="multiple">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                        <h3 class="ml-4" style="color:#005f73;font-weight:bold;">Kết quả nội soi</h3>
                            <div class="col-md-12">
                                <textarea name="ketquans" id="editor1" cols="30" rows="30">
                                   {!! $dsns->cls_form !!}
                                </textarea>
                            </div>
                        </div>
...
$('#anhnoisoi').on("change", previewImages);
    </script>
