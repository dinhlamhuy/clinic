...
<title>Quản lý triệu chứng</title>
@endsection
        ...
        <div class="row ">
            <div class="col-md-12 pl-4 pr-4">
                <div class="row " style="margin-top:-20px;">
                    <div class="col-md-12">
                        <span class="admin_titile">Quản lý triệu chứng</span>
                    </div>
                    ...
                    <div class="col-md-12 pl-3 pr-1 pt-1 " style="background-color: white;">
                        <div class="row ">
                            <div class="col-md-4"  style="border-left: 1px solid #b1154a;border-right: 1px solid #b1154a;border-top: 1px solid #b1154a;">
                                <center>
                                    <h4 class="mt-2">Thêm triệu chứng</h4>
                                </center>
                                <form action="{{ URL::to('/admin/add_symptom') }}" class="mt-1" method="post">
                                    @csrf
                                            <input type="text" class="form-control" name="tentrieuchung" placeholder="Nhập triệu chứng mới" required>
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            <center>
                            ...
                            <div class="col-md-8">
                                <table id="dstrieuchung" class="display pt-2" style="width:100%;">
                                    <thead>
                                        <tr class="tbl_header">
                                    ...
                                    @foreach($dstrieuchunglichhen as $trchung)
                                        <tr>
                                            <td width="20%;" class="text-center">{{ 'TC'.sprintf('%04d', $trchung->tclh_ma )}}</td>
                                            ...
                                            <td width="16%;" class="text-center">
                                                ...
                                                <button type="button" class="btn btn-info float-left ml-3" data-toggle="modal"
                                                    data-target="#edittrchung{{ $trchung->tclh_ma }}"><i class="fa fa-pencil-square-o"
                                                        aria-hidden="true"></i></button>

<!-- Modal edit triệu chứng -->
<div class="modal fade" id="edittrchung{{ $trchung->tclh_ma }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ URL::to('/admin/edit_symptom') }}" method="post">
                    @csrf
                    <div class="container-fluid">
                        <div class="form-group">
                                <label for="" class="col-form-label chu float-left">Mã triệu chứng:</label>
                                <input type="hidden" name="tclh_ma"  value="{{ $trchung->tclh_ma }}">
                                <input type="text" class="form-control" disabled value="{{ 'TC'.sprintf('%04d',$trchung->tclh_ma) }}">
                        </div>
                        <div class="form-group">
                            <label for="" class="col-form-label chu float-left">Tên triệu chứng:</label>
                            <input type="text" class="form-control" name="tclh_ten" value="{{ $trchung->tclh_ten }}" required>
                        </div>
                    ...
                    <button type="submit" class="btn btn-primary center"><i class="fa fa-floppy-o"
                        aria-hidden="true"></i>&ensp;Lưu</button>
                                                        ...
                                                        <form action="{{ URL::to('/admin/delete_symptom') }}" method="post">
                                                            @csrf
                                                        <input type="hidden" name="tclh_ma" value="{{ $trchung->tclh_ma }}">
...
<script>
    ...
    $('#quanlytrieuchung').addClass('active');
    $(document).ready(function() {
        $('#dstrieuchung').DataTable({
            language: {
        ...
        <?php
            ...
            $('.show_confirm').click(function(event) {
                ...
                Swal.fire({
                        title: 'Bạn chắc chưa?',
                        text: "Bạn sẽ xóa triệu chứng này",
                        icon: 'warning',
