		...
		<div class="col-md-6">
			<div class="log-w3">
				<div class="w3layouts-main">
					<h2 style="color:white;font-weight:bold;">Đăng nhập quyền quản trị</h2>
					<?php
					$mess = session()->get('mess');
					if ($mess) {
						echo '<span style="color:white; width:500px;text-align:center;">' . $mess . '</span>';
						session()->put('mess', null);
					}
					?>
					<form action="{{URL::to('/admin/admin_login')}}" method="post">
						@csrf
						<input type="text" class="ggg" name="account" placeholder="Tài khoản" required autocomplete="off">
						<input type="password" class="ggg" name="password" placeholder="Mật khẩu" required autocomplete="off">
						<!-- <span><input type="checkbox" />Hiện mật khẩu</span> -->
